...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=trisberg&repo=tanzu-test",
  "projectName" : "tanzu-test",
  "repositoryPrefix" : "gcr.io/cf-sandbox-trisberg/tap"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-test]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[1].<combo>.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->gcr.io/cf-sandbox-tr...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=trisberg&repo=tanzu-test'
